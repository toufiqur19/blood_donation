<x-app-layout>
    <header class="banner text-center">
        ...
        <div class="header_item">
            <a href="">home / </a>
            <a href="" class="{{Request::is('donor/create')?'text-danger':''}}">donor create</a>
            <h4 class="slogan mt-3 ">Blood cannot be manufactured but can be donated.</h4>
        </div>
    </header>
   
    @if (Auth::user())
    <section class="donor mt-4 mx-5 text-black mb-5">
        <div class="pt-3 px-5 flex justify-content-between ">
            <h1 class="fs-4 fw-bold ">Donor Informations</h1>
        </div>
            ...
            <form action="{{route('home.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex gap-3">
                    <div class="mb-3 w-100 ">
                      ...
                      <div class="mb-3 w-100 ">
                        ...
                        <input type="text" name="in" class="form-control h-50" {{old('in')}}>
                        @if($errors->has('in'))
                ...
                <div class="flex gap-3">
                    <div class="mb-3 w-100 ">
                        ...
                        <input type="text" name="fb" class="form-control h-50" {{old('fb')}}>
                        @if($errors->has('fb'))
               ...
               <div class="flex justify-content-between ">
                ...
                <button type="submit" name="submit" class="btn mb-5 bg-primary">Submit</button>
            </div>
              </form>
        </div>
    </section> 
    @else
    <h1 class="text-center mt-5 ">login to create donor</h1>
